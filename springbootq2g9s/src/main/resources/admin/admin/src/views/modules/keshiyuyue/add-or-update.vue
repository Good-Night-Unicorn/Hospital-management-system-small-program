...
export default {
  ...
  created() {
	this.ruleForm.yuyueriqi = this.getCurDate()
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `keshiyuyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.keshiyuyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
