        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiwangshi" label="既往史" prop="jiwangshi">
                    <span>{{ruleForm.jiwangshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="诊断情况" prop="zhenduanqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="诊断情况"
                  v-model="ruleForm.zhenduanqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhenduanqingkuang" label="诊断情况" prop="zhenduanqingkuang">
                    <span>{{ruleForm.zhenduanqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
