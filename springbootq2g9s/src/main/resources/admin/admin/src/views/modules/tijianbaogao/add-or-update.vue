<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.baogaotupian" label="报告图片" prop="baogaotupian">
          <file-upload
          tip="点击上传报告图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.baogaotupian" label="报告图片" prop="baogaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.baogaotupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="检查情况" prop="jianchaqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="检查情况"
                  v-model="ruleForm.jianchaqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianchaqingkuang" label="检查情况" prop="jianchaqingkuang">
                    <span>{{ruleForm.jianchaqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yizhu" label="医嘱" prop="yizhu">
                    <span>{{ruleForm.yizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baogaotupian = true;
          ...
          if(o=='jianchaqingkuang'){
            this.ruleForm.jianchaqingkuang = obj[o];
	    this.ro.jianchaqingkuang = true;
            continue;
          }
          if(o=='yizhu'){
