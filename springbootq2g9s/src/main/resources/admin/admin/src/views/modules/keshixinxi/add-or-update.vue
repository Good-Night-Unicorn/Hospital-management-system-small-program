<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科室编号" prop="keshibianhao">
          <el-input v-model="ruleForm.keshibianhao" 
              placeholder="科室编号" clearable  :readonly="ro.keshibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科室编号" prop="keshibianhao">
              <el-input v-model="ruleForm.keshibianhao" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="科室简介" prop="keshijianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.keshijianjie" label="科室简介" prop="keshijianjie">
                    <span v-html="ruleForm.keshijianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    zhanghaoChange () {
      this.$http({
        url: `follow/yisheng/zhanghao?columnValue=`+ this.ruleForm.zhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.keshijianjie = this.ruleForm.keshijianjie.replace(reg,'../../../springbootq2g9s/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
